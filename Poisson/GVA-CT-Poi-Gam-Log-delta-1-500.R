...
plot1 <- 
  ggplot()+                   # 添加连线
  geom_point(data = Poi.gvatime, aes(x=x, y=y, color = "blue"), size =3) + 
  geom_point(data = Log.gvatime, aes(x=x, y=y, color = "red"), size = 3) +
  geom_point(data = Gam.gvatime, aes(x=x, y=y, color = "green"), size =3) +
  geom_line(data = Poi.gvatime, aes(x=x, y=y, color = "blue")) +
  geom_line(data = Log.gvatime, aes(x=x, y=y, color = "red")) +
